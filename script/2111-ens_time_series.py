...
title = "calypso-gfs %s (%s) (%.2fN,%.2fE) "%(filname[nv],unit[nv],lat,lon)
...
axe.fill_between(ftime, np.mean(var,axis=0)-np.std(var,axis=0),\
    np.mean(var,axis=0)+np.std(var,axis=0),color="blue",alpha=0.25)
